...
urlpatterns = [
    ...
    path('bills/create/upfrontfees/<int:investment_id>', create_upfront_fees, name = 'create_upfront_fees'),
    path('bills/create/yearlyfees/<int:investment_id>', create_yearly_fees, name = 'create_upfront_fees'),
